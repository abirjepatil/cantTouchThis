 ...
 * @description This directive us a custom directive made to transition new views into the parent view. It is currently used by the animated-view directive in RelayrDashboard.html file.
 *
 * ## 
 */
    ...
    return {
        ...
        link: function (scope, element, attr) {
            ...
            function animate(animationType) {
                //$(element.children()).addClass("show").find("article, section").addClass("show");
                return;
